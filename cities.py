...
plt.scatter(lon, lat, label=None, c=np.log10(pop), cmap='Spectral', s=area, linewidth=0, alpha=0.5)
# Customize and save figures
plt.axis('equal')
...
for area in [100, 300, 500]:
    plt.scatter([],[], c='k', alpha=.03, s=area, label=str(area) + 'km$^2$')
